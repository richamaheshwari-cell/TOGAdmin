...
import { useCreateGameArticle } from "@/hooks/useGameArticles";
...
export default function NewGameArticlePage() {
  const router = useRouter();
  const create = useCreateGameArticle();
  ...
  return (
    <ArticleEditorLayout
      title="Create New Game Article"
      subtitle="Fill in the details to publish a new game article."
      backHref="/game-articles"
      backLabel="Back to Game Articles"
      submitLabel="Publish Article"
      cancelHref="/game-articles"
