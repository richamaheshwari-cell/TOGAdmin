...
import { useCreateBonusArticle } from "@/hooks/useBonusArticles";
...
export default function NewBonusArticlePage() {
  const router = useRouter();
  const create = useCreateBonusArticle();
  ...
  return (
    <ArticleEditorLayout
      title="Create New Bonus Article"
      subtitle="Fill in the details to publish a new bonus article."
      backHref="/bonus-articles"
      backLabel="Back to Bonus Articles"
      submitLabel="Publish Article"
      cancelHref="/bonus-articles"
